(function() {
  ...
  module["export"] = function(gitaxfile, gi, namesfile) {
  ...
  exports.run = function() {
    var ap, e, file, gi, name, namesfile, tax_id, _i, _len, _ref, _results;
    try {
      ap = require("argparser").vals("names").files(0, "names").nums(1).parse();
    } catch (_error) {
      e = _error;
